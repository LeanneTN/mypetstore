...
public class ProductDAOImpl implements ProductDAO {
    ...
    private static final String GET_PRODUCE = "SELECT PRODUCTID, NAME, DESCN as description, CATEGORY as categoryId FROM PRODUCT WHERE PRODUCTID = ?";
    ...
    public Product getProduct(String productId) {
        ...
        try{
            Connection connection = DBUtil.getConnection();
            PreparedStatement pStatement = connection.prepareStatement(GET_PRODUCE);
